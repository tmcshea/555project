...
# US19: checks for cousin marraige
	def test_us19_noCousinMarraige(self):
		self.assertEqual(familyTreeParser.noCousinMarraige('random'), False)
		self.assertEqual(familyTreeParser.noCousinMarraige(''), False)
		self.assertEqual(familyTreeParser.noCousinMarraige('@F6@'), False)
		self.assertEqual(familyTreeParser.noCousinMarraige('@F1@'), True)
		self.assertEqual(familyTreeParser.noCousinMarraige('@F3@'), True)
...
# US20: check for marraige between uncle/aunt and neice/nephew
	def test_us20_noAuntUncle(self):
		...
		self.assertEqual(familyTreeParser.noAuntsAndUncles('@F1@'), True)
		self.assertEqual(familyTreeParser.noAuntsAndUncles('@F4@'), False)
		self.assertEqual(familyTreeParser.noAuntsAndUncles('@F3@'), True)
